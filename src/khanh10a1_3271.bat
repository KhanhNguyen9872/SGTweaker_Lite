...
echo.
echo       1 = Android 7.1.2 (Beta Lite)
echo       2 = Android 4.4.2 (MOD v3.2 Lite)
echo       E = Exit
echo.
SET /P AREYOUSURE=Lua chon cua ban: 
IF %AREYOUSURE%==1 GOTO ANDROID7
IF %AREYOUSURE%==2 GOTO ANDROID44
...
cls
echo CONSOLE_MODE: YES
%windir%\khanh10a1\framework\khanh12a1.vbs
exit
