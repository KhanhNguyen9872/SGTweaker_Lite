...
echo     3 = Thay doi ngon ngu SmartGaGa MODv3.2 Lite (Change Language)
echo     4 = Thay lib DirectX (OpenGL 2.0, fix loi do hoa 1 so game)
echo     5 = Reset SmartGaGa MODv3.2 Lite Android 4.4.2
echo     6 = Xoa SmartGaGa MODv3.2 Lite (Uninstall SmartGaGa MODv3.2 Lite)
echo     7 = Them Apps vao SmartGaGa MODv3.2 Lite (SystemUI, CH Play,...)
echo     8 = Thay doi Do phan giai (Change Resolution)
echo     9 = Mau sac HDR cho SmartGaGa MODv3.2 Lite (HDR Color)
...
cls
echo CONSOLE_MODE: YES
%windir%\khanh10a1\framework\khanhvuinguyenvan\vi\ERROR005_khanh.vbs
GOTO KHANH10A1
...
IF not EXIST "%windir%\khanh10a1\lib\khanh10a1_15.dll" GOTO ERROR005
timeout 01
cls
echo CONSOLE_MODE: YES
echo.
...
taskkill /F /IM TitanService.exe
timeout 01
execute x %windir%\khanh10a1\lib\khanh10a1_15.dll -pUC1Npa_Mu85Qo1Rut5K1Rh7g -aoa -y
cls
echo CONSOLE_MODE: YES
echo       -Dang Reset SmartGaGa Lite by khanh10a1-
echo.
...
echo.
echo.
echo    Process: khanh10a1_15.dll has been executed.
timeout 01
cls
echo CONSOLE_MODE: YES
echo       -Dang Reset SmartGaGa Lite by khanh10a1-
...
echo.
echo.
echo    Process: khanh10a1_15.dll execute successfully.
echo.
rmdir /q /s "%windir%\khanh10a1\framework\androidfs"
pause
GOTO EXIT
...
cls
echo CONSOLE_MODE: YES
execute x %windir%\khanh10a1\lib\khanh10a1_1.dll -pUC1Npa_Mu85Qo1Rut5K1Rh7g -aoa -y
echo.
echo.
echo    -Dang them Superuser + SystemUI vao SmartGaGa Lite by khanh10a1-
echo.
...
echo.
echo.
echo    Process: khanh10a1_19.dll execute successfully.
echo    Try asking root right: 
timeout 01
cls
echo CONSOLE_MODE: YES
